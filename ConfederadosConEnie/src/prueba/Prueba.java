...
public class Prueba {
	...
	public static void main(String[] args) {
		...
		String abecedarioCompleto="abcdefghijklmnñopqrstuvwyxzABCDEFGHIJKLMNÑOPQRSTUVWXYZ"; //ABECEDARIO COMPLETO
		String abecedarioIncompleto="ABCDEFGHIJKLMNÑOPQRSTUVWXYZ";
	...
	public static String encriptacionConfederados(String mensaje,char[] clave, String abecedario) {
		...
		System.out.println("Encriptado Confederados con Ñ:" + encriptado);
